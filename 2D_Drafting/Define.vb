...
Public Structure SegObject
    ...
    Public BlobSegObj As BlobList
    Public ceptObj As InterCeptObj
...
Public Class InterCeptObj
    Public Degree As Single
    Public numLine As Integer
    Public CeptCnt(100) As Integer
    Public CeptPos(100, 1000) As PointF
    Public thr_seg As Integer
    Public lineLength(100) As Single           'pixel counts
...
Public Class LineCeptList
    Public CeptList As List(Of LineCept) = New List(Of LineCept)
...
Public Structure LineCept
    Public field As String
    Public InterNo As Single
    Public Dia As Single
    Public GrainArea As Single
    Public GrainNo As Single
    Public totalArea As String
End Structure

Public Structure CircleCept
    Public field As String
    Public InterNo As Integer
    Public GrainSize As Integer
End Structure
