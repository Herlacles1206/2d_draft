...
Public Class Count_Classification
    ...
    Private textFont As Font = New Font("Arial", 10, FontStyle.Regular)
    ...
    Private Sub BtnCount_Click(sender As Object, e As EventArgs) Handles BtnCount.Click
        ...
        Try
            ...
            If AreaLimit Then
                BlobDetection(OriImage, BinaryImage, Main_Form.Obj_Seg.BlobSegObj.BlobList, AreaLimit)
                DrawLabelForCount(Main_Form.ID_PICTURE_BOX(Main_Form.tab_Index), Main_Form.Obj_Seg.BlobSegObj.BlobList, textFont)
                GetMinMax()
                LoadDataToGridView()
    ...
    Private Sub Intialize()
        ...
        Main_Form.currentImageList(Main_Form.tab_Index) = Main_Form.originImageList(Main_Form.tab_Index).Clone()
    End Sub
    ...
    Private Sub BtnReport_Click(sender As Object, e As EventArgs) Handles BtnReport.Click
        ...
        Dim title = "Save"
        SaveListToReport(Main_Form.ID_PICTURE_BOX(Main_Form.tab_Index), DataGridView1, filter, title, Main_Form.Obj_Seg, textFont)
    End Sub
