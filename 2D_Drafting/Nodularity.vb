...
Public Class Nodularity
    ...
    Private Sub BtnSetLimit_Click(sender As Object, e As EventArgs) Handles BtnSetLimit.Click
        Dim form = New RoundnessLimit(BinaryImage, AreaLimit, DistingshType)
        If form.ShowDialog() = DialogResult.OK Then
    ...
    Private Sub Nodularity_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        OriImage.Dispose()
        GrayImage.Dispose()
        BinaryImage.Dispose()
    End Sub
